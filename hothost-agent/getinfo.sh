...
do
  ...
  curl $HOTHOST_SERVER_HOST/data/ -d
  $MONITOR_INTERVAL_SECONDS
  echo "CONTAINER_OS_NAME=${CONTAINER_NAME}"
  echo "CONTAINER_OS_ID=${CONTAINER_ID}"
  echo "CONTAINER_OS_ID_LIKE=${CONTAINER_ID_LIKE}"
  echo "CONTAINER_OS_VERSION=${CONTAINER_VERSION}"
  echo "CONTAINER_OS_VERSION_ID=${CONTAINER_VERSION_ID}"
  echo "CONTAINER_OS_DETECTION=${CONTAINER_OS_DETECTION}"
  echo "CONTAINER_IS_OFFICIAL_IMAGE=${CONTAINER_IS_OFFICIAL_IMAGE}"
  echo "HOST_NAME=${HOSTNAME}"
  echo "HOST_OS_NAME=${HOST_NAME}"
  echo "HOST_OS_ID=${HOST_ID}"
  echo "HOST_OS_ID_LIKE=${HOST_ID_LIKE}"
  echo "HOST_OS_VERSION=${HOST_VERSION}"
  echo "HOST_OS_VERSION_ID=${HOST_VERSION_ID}"
  echo "HOST_OS_DETECTION=${HOST_OS_DETECTION}"
  echo "HOST_IS_K8S_NODE=${HOST_IS_K8S_NODE}"
  echo "SYSTEM_KERNEL_NAME=${KERNEL_NAME}"
  echo "SYSTEM_KERNEL_VERSION=${KERNEL_VERSION}"
  echo "SYSTEM_ARCHITECTURE=${ARCHITECTURE}"
  echo "SYSTEM_VIRTUALIZATION=${VIRTUALIZATION}"
  echo "SYSTEM_VIRT_DETECTION=${VIRT_DETECTION}"
  echo "SYSTEM_CONTAINER=${CONTAINER}"
  echo "SYSTEM_CONTAINER_DETECTION=${CONT_DETECTION}"
  echo "SYSTEM_CPU_LOGICAL_CPU_COUNT=${LCPU_COUNT}"
  echo "SYSTEM_CPU_VENDOR=${CPU_VENDOR}"
  echo "SYSTEM_CPU_MODEL=${CPU_MODEL}"
  echo "SYSTEM_CPU_FREQ=${CPU_FREQ}"
  echo "SYSTEM_CPU_DETECTION=${CPU_INFO_SOURCE}"
  echo "SYSTEM_TOTAL_RAM=${TOTAL_RAM}"
  echo "SYSTEM_FREE_RAM=${FREE_RAM}"
  echo "SYSTEM_TOTAL_SWAP=${TOTAL_SWAP}"
  echo "SYSTEM_FREE_SWAP=${TOTAL_SWAP}"
  echo "SYSTEM_RAM_DETECTION=${RAM_DETECTION}"
  echo "SYSTEM_TOTAL_DISK_SIZE=${DISK_SIZE}"
  echo "SYSTEM_DISK_DETECTION=${DISK_DETECTION}"
  echo "INSTANCE_CLOUD_TYPE=${CLOUD_TYPE}"
  echo "INSTANCE_CLOUD_INSTANCE_TYPE=${CLOUD_INSTANCE_TYPE}"
  echo "INSTANCE_CLOUD_INSTANCE_REGION=${CLOUD_INSTANCE_REGION}"
  echo "DISK_USED=${DISK_USED}"
  echo "DISK_AVAIL=${DISK_AVAILABLE}"
