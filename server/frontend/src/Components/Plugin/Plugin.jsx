    ...
    <div className="container mx-auto px-4 flex justify-center ">
      <div className="p-4 my-5 bg-gray-100 rounded-lg shadow-md sm:p-8 dark:bg-gray-600 dark:border-gray-700 w-max mobile:container">
        ...
        <div className="mb-5 flex flex-wrap items-center gap-3">
          ...
          {plugin.groupName && (
            <span className="mt-1 inline-flex items-center gap-1.5 rounded-full bg-green-100 px-3 py-1 text-sm font-medium text-green-800 dark:bg-green-900/40 dark:text-green-300">
