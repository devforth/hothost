      ...
      <nav className="bg-white sticky top-0 mb-4 w-full shadow-md z-50 min-w-full border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a href="/" className="flex items-center">
            ...
            <div className="flex text-xl font-semibold whitespace-nowrap dark:text-white">
              <img className="h-9" src="./src/assets/logo.svg" alt="logo" />
          ...
          <div className="flex md:order-2">
            {/* {{#if (not authorized)}}
        <a href="/login/" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</a>
        {{else}} */}
            <div className="px-2">
              <svg
