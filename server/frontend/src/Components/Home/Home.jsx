...
const Home = ({ authorized }) => {
  ...
  return (
    <div className="w-[100vw]">
      <div className="mx-auto pt-4 px-4 flex justify-center w-[100vw] mobile:max-w-max">
        <div className=" mb-4">
          <div className="flex mb-1 w-[100vw]">
                ...
                <div id="myTabContent-{{ this.id }}">
                  ...
                  >
                    ...
                    >
                      ...
                      restart: unless-stopped cap_add: - SYS_PTRACE
                      security_opt: - apparmor:unconfined - seccomp:unconfine
                  ...
                  >
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      If you want to run agent locally without Docker you can
                      add cron job which starts on boot.
                    </p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 relative">
