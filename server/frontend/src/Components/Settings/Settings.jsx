      ...
      <div class="container mx-auto flex justify-center">
        <div class=" p-4 my-5 mx-5 bg-gray-100 rounded-lg shadow-md sm:p-8 dark:bg-gray-600 dark:border-gray-700">
          ...
          <div class="w-full block divide-gray-200 dark:divide-gray-700">
            <form action="/api/edit_settings" method="post">
              <div class="mb-5">
                <label
                  for="disk_threshold"
                  class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-200"
                >
                  Disck usage threshold in percents.
                </label>
                <input
                  name="disk_threshold"
                ...
                <p class="text-xs text-gray-400 dark:text-gray-300">
                  If disk usage exceeds this value then disk_is_almost_full
                  alert is generated
                </p>
              </div>
              <div class="mb-5">
              ...
              <div class="mb-5">
                ...
                />
                <p class="text-xs text-gray-400 dark:text-gray-300">
                  If RAM usage exceeds this value then ram_is_almost_full alert
                  is generated.
                </p>
              </div>
              <div class="mb-5">
